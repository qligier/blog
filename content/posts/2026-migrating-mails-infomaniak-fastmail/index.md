...
log you out of you account each time.
...
There are also some missing features that I would expect, like a calendar containing birthdays from the contacts, or
...
Fastmail provides a nice guide to set up the DNS records for your domain, and it XXXXXXX
...
5, while the new Fastmail records have priorities of 10 and 20. This could have increase the time needed for the change
to be effective, because a mail server that cached the old record would still choose it over the new ones.
...
19'402 messages (around 1 Go of data in total).
...
There was not much more to do to complete the migration.
